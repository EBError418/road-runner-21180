...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        ...
        double weight = 1.03;
        public double par0YTicks =  -1480.7261935082067 * weight;// * 1.016; //-6.75 / 0.00294 // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 1392.7850526578486 * weight;//   * 1.016; //6.75 / 0.00294; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -2356.807029513809 * weight; //-6.75 / 0.00294; // x position of the perpendicular encoder (in tick units)
    }
