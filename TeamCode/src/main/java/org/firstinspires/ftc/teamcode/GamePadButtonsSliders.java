 ...
 *
 */
public class GamePadButtonsSliders {
    //game pad setting
    ...
    public void checkGamepadButtons(@NonNull Gamepad gamepad1, @NonNull Gamepad gamepad2) {
        ...
        armBackward = gamepad2.left_stick_y < 0;

        //slider
        sliderUp = gamepad2.right_stick_y < -0.1;
        sliderDown = gamepad2.right_stick_y > 0.1;
        sliderMin = gamepad2.x;
        sliderMax = gamepad2.y;

        sliderUpDown  = gamepad2.right_stick_y;

        //presets
        pickupPos = gamepad2.left_bumper;
        highestPos = gamepad2.right_bumper;
    }
}
